...
function generateMockHistory(days: number = 30): HistoricalDataPoint[] {
...
export {
  generateMockHistory,
  example1_BasicPrediction,
  example2_EconomicForecast,
  example3_ScenarioSimulation,
  example4_ScenarioComparison,
  example5_MonteCarlo,
  example6_GlobalInstances,
  runAllExamples,
};
