...
import { EchoSurvivalManager, formatSurvivalReport, shouldAcceptTask } from '@agora/sdk';
/**
...
export class ConsultantAgentWithSurvival extends ConsultantAgent {
    ...
    async processTask(taskRequest) {
        ...
        const taskDecision = shouldAcceptTask(this.lastSnapshot, taskRequest.budget.toString(), estimatedTaskCost, 0.15 // 15% minimum profit margin
        );
