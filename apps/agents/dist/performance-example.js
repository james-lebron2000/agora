 ...
 */
import { createPerformanceMonitor, benchmark, measureLatency, measureLatencyAsync, withLatencyTracking, withLatencyTrackingAsync, trackMemory, generateOptimizationReport, createCache, withPerformanceCache, createBatchProcessor, createWebSocketPool, createLazyLoader, createRateLimiter, withDeduplication, createBundleOptimizer, prefetchModule, } from '../../../packages/sdk/src/performance.js';
// ============================================================================
 ...
 */
export async function exampleBenchmarking() {
    console.log('\n⏱️ Benchmarking Example\n');
    // Benchmark a synchronous function
    const syncResult = await benchmark('fibonacci', () => {
        function fib(n) {
    ...
    const asyncResult = await benchmark('async-operation', async () => {
 ...
 */
export async function exampleLatencyTracking() {
    console.log('\n🎯 Latency Tracking Example\n');
    const monitor = createPerformanceMonitor();
    // Track synchronous function
    const trackedSyncFn = withLatencyTracking((n) => {
        // Simulate work
    ...
    const trackedAsyncFn = withLatencyTrackingAsync(async (id) => {
    ...
    const { result: asyncResult, latencyMs: asyncLatency } = await measureLatencyAsync(async () => {
 ...
 */
export async function exampleMemoryMonitoring() {
...
export async function exampleCaching() {
    ...
    // Wrap with caching
    const cachedFetch = withPerformanceCache(fetchUserData, (userId) => `user:${userId}`, cache);
 ...
 */
export async function exampleWebSocketPooling() {
...
export async function exampleLazyLoading() {
    ...
    const heavyLoader = createLazyLoader(async () => {
        console.log('  [LOADER] Loading heavy module...');
        await new Promise(resolve => setTimeout(resolve, 500));
        return {
            processData: (data) => `Processed ${data.length} items`,
            expensiveCalculation: (n) => n * n * n,
        };
    }, {
        preload: true,
        preloadDelayMs: 2000,
 ...
 */
export async function exampleBundleOptimization() {
 ...
 */
export async function examplePerformanceBudgets() {
 ...
 */
export async function exampleOptimizationReport() {
...
//# sourceMappingURL=performance-example.js.map