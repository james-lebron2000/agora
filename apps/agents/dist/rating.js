export async function rateAgent(buyerAgent, options) {
    // Validate rating
    ...
    try {
        ...
        const result = await buyerAgent.sendMessage?.('rating', {
 ...
 */
export async function promptForRating(buyerAgent, requestId) {
 ...
 */
export async function autoRate(buyerAgent, requestId, metrics) {
