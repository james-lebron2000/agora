 ...
 */
import { createMobileAgent, isMobileEnvironment, getMobileConfig, } from './mobile-adapter.js';
// ============================================================================
 ...
 */
async function createBasicMobileAgent() {
 ...
 */
async function createGestureEnabledAgent(elementId) {
 ...
 */
async function createPerformanceAwareAgent() {
 ...
 */
async function handleMobileRequests(agent) {
    ...
    await agent.onRequest(async (envelope) => {
        ...
        // Send result back
        await agent.sendResult(payload.request_id || 'unknown', { output: adaptedResponse.content });
    });
}
/**
 ...
 */
function demonstrateUIRecommendations(agent) {
...
//# sourceMappingURL=mobile-example.js.map