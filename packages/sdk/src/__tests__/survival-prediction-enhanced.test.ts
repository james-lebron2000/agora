...
import {
  ...
  predictSurvivalProbability,
  generateRiskFactors,
  type MultiFactorRiskInput,
  type RiskFactor,
  type SurvivalProbability,
...
describe('calculateMultiFactorRiskScore', () => {
  describe('normal input scenarios', () => {
    it('should return correct risk score for balanced input', () => {
      const input: MultiFactorRiskInput = {
        economicHealth: 70,
        reputationScore: 80,
  ...
  describe('weight validation', () => {
    it('should give highest weight to economic health', () => {
      const economicOnlyInput: MultiFactorRiskInput = {
      ...
      const otherInput: MultiFactorRiskInput = {
        economicHealth: 100,
    ...
    it('should correctly weight task performance', () => {
      const input1: MultiFactorRiskInput = {
        economicHealth: 100,
        reputationScore: 100,
        taskSuccessRate: 0.0,
        onlineHours: 25,
      ...
      const input2: MultiFactorRiskInput = {
        economicHealth: 100,
        reputationScore: 100,
        taskSuccessRate: 1.0,
        onlineHours: 25,
