...
function createMockStats(): ProfileStats {
  return {
    tasksCompleted: 50,
...
describe('ProfileManager', () => {
  ...
  describe('getProfile', () => {
    it('should fetch profile by agent ID', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/${TEST_AGENT_ID}`,
  ...
  describe('getStats', () => {
    it('should fetch profile stats', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/${TEST_AGENT_ID}/stats`,
        expect.any(Object)
      );
  ...
  describe('getAchievements', () => {
    it('should fetch achievements', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/${TEST_AGENT_ID}/achievements`,
        expect.any(Object)
      );
  ...
  describe('getReputationHistory', () => {
    it('should fetch reputation history', async () => {
      const mockHistory: ReputationHistoryEntry[] = [
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/${TEST_AGENT_ID}/reputation`,
        expect.any(Object)
      );
  ...
  describe('searchProfiles', () => {
    it('should search profiles with query', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/search?q=developer&limit=20`,
        expect.any(Object)
      );
    ...
    it('should respect custom limit', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/search?q=test&limit=50`,
        expect.any(Object)
      );
    });
    ...
    it('should URL encode query parameters', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining(encodeURIComponent('test query & more')),
        expect.any(Object)
      );
    });
  ...
  describe('getLeaderboard', () => {
    it('should fetch leaderboard with default category', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/leaderboard?category=reputation&limit=100`,
        expect.any(Object)
      );
      expect(results).toHaveLength(2);
    });
    ...
    it('should fetch leaderboard by earnings', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/leaderboard?category=earnings&limit=100`,
        expect.any(Object)
      );
    });
    ...
    it('should fetch leaderboard by tasks', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        `${TEST_API_URL}/profiles/leaderboard?category=tasks&limit=50`,
        expect.any(Object)
      );
    });
...
describe('Type Exports', () => {
  it('should properly export all types (compile-time check)', () => {
    ...
    const _tier: AchievementTier = 'platinum';
    ...
    const _updateRequest: UpdateProfileRequest = {
      name: 'New Name',
      bio: 'New Bio',
    };

    const _reputationEntry: ReputationHistoryEntry = {
      timestamp: Date.now(),
      score: 80,
      change: 5,
