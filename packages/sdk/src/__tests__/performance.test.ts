...
describe('PerformanceMonitor', () => {
  ...
  describe('alerts', () => {
    it('should trigger alert callback on high latency', () => {
      ...
      const alert = alertHandler.mock.calls[0][0] as PerformanceAlert;
...
describe('withLatencyTracking', () => {
  it('should wrap function with latency tracking', () => {
    ...
    const trackedFn = withLatencyTracking((a: number, b: number) => a + b, testMonitor);
...
describe('withLatencyTrackingAsync', () => {
  it('should wrap async function with latency tracking', async () => {
    ...
    const trackedFn = withLatencyTrackingAsync(async (x: number) => {
      await new Promise(resolve => setTimeout(resolve, 1));
      return x * 2;
    }, testMonitor);
...
describe('Type Exports', () => {
  it('should have all required type definitions', () => {
    ...
    const leakResult: LeakDetectionResult = {
      hasLeak: false,
      confidence: 0,
      growthRate: 0,
      suspectedSources: [],
