...
describe('PerformanceTracker', () => {
  ...
  it('factory function should create tracker', () => {
...
describe('MemoryMonitor', () => {
  ...
  it('factory function should create monitor', () => {
...
describe('MetricCollector', () => {
  ...
  it('should get recent records by time window', (done) => {
  ...
  it('factory function should create collector', () => {
