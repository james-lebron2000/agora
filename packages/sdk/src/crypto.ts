 ...
 */
export function generateEncryptionKeyPair(): BoxKeyPair {
 ...
 */
function deriveCurve25519KeyPairFromEd25519SecretKey(ed25519SecretKey: Uint8Array): BoxKeyPair {
 ...
 */
export function convertEd25519ToCurve25519(ed25519KeyPair: SignKeyPair): BoxKeyPair {
 ...
 */
export function getCurve25519PublicKeyFromEd25519KeyPair(ed25519KeyPair: SignKeyPair): Uint8Array {
 ...
 */
export function encryptMessageForEd25519Recipient(
  message: string,
  recipientEd25519KeyPair: SignKeyPair
): string {
 ...
 */
export function decryptMessageWithEd25519Key(
  encryptedMessage: string,
  ed25519KeyPair: SignKeyPair
): string {
