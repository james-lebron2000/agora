...
// ============================================================================
// Multi-Factor Risk Prediction Functions
// ============================================================================
...
export function predictSurvivalProbability(
  ...
  const confidence =
    normalizedRisk < 0.2 || normalizedRisk > 0.8 ? 0.85 : 0.70;
 ...
 */
export function generateRiskFactors(input: MultiFactorRiskInput): RiskFactor[] {
