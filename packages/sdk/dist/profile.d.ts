 ...
 */
export declare function getProfileCache(): ProfileCache;
/**
 * Batch fetch multiple profiles efficiently
 */
export declare function batchGetProfiles(apiUrl: string, agentIds: string[], authToken?: string): Promise<Map<string, AgentProfile>>;
/**
 ...
 */
export declare function checkProfileCompleteness(profile: AgentProfile): ProfileCompleteness;
/**
 * Save profile to localStorage for offline access
 */
export declare function saveProfileToLocalStorage(profile: AgentProfile): void;
/**
 * Load profile from localStorage
 */
export declare function loadProfileFromLocalStorage(agentId: string): AgentProfile | null;
/**
 * Clear cached profile from localStorage
 */
export declare function clearProfileFromLocalStorage(agentId: string): void;
/**
 ...
 */
export declare function createOptimisticProfileUpdate(profile: AgentProfile, updates: Partial<AgentProfile>): OptimisticUpdate<AgentProfile>;
/**
 ...
 */
export declare function uploadAvatar(apiUrl: string, file: File, authToken: string, onProgress?: (percent: number) => void): Promise<AvatarUploadResult>;
/**
