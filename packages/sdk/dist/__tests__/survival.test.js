...
import { EchoSurvivalManager, getOrCreateSurvivalManager, getSurvivalManager, removeSurvivalManager, DEFAULT_SURVIVAL_CONFIG, formatSurvivalReport, shouldAcceptTask } from '../survival.js';
...
describe('Type Exports', () => {
    it('should properly export all types (compile-time check)', () => {
        const _healthStatus = 'healthy';
        const _actionType = 'bridge';
        const _action = {
            type: 'earn',
            priority: 'high',
        ...
        const _eventType = 'health:critical';
        expect(true).toBe(true);
    });
});
//# sourceMappingURL=survival.test.js.map