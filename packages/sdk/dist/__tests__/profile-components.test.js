...
import { ProfileCard, AchievementBadge, LevelProgress, ReputationScore, ProfileStatsGrid, SkillTags, ThemeProvider, lightTheme, } from '../profile-components.js';
// Test utilities
const renderWithTheme = (ui, defaultTheme = 'light') => {
    return render(_jsx(ThemeProvider, { defaultTheme: defaultTheme, children: ui }));
};
// Mock data
const mockProfile = {
    id: 'agent-1',
...
describe('ProfileCard', () => {
    ...
    it('should render full variant with all elements', () => {
        renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "full", showAvatar: true, showStats: true }));
    ...
    it('should render compact variant with reduced elements', () => {
        renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "compact", showAvatar: true, showStats: true }));
        expect(screen.getByText('Test Agent')).toBeInTheDocument();
        expect(screen.getByText('Tasks')).toBeInTheDocument();
        expect(screen.getByText('Earned')).toBeInTheDocument();
    ...
    it('should render minimal variant with basic info only', () => {
        renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "minimal", showAvatar: true }));
        expect(screen.getByText('Test Agent')).toBeInTheDocument();
    ...
    it('should handle click events on edit button', () => {
        renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "full", onEdit: mockOnEdit }));
        const editButton = screen.getByRole('button', { name: /edit profile/i });
        fireEvent.click(editButton);
        expect(mockOnEdit).toHaveBeenCalledTimes(1);
    });
    it('should not show edit button when onEdit is not provided', () => {
        renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "full" }));
    ...
    it('should render avatar placeholder when avatarUrl is not provided', () => {
        ...
        renderWithTheme(_jsx(ProfileCard, { profile: profileWithoutAvatar, variant: "full", showAvatar: true }));
    ...
    it('should apply correct theme colors based on theme context', () => {
        const { container: lightContainer } = renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "full" }), 'light');
    ...
    it('should not display verified badge when profile is not verified', () => {
        ...
        renderWithTheme(_jsx(ProfileCard, { profile: unverifiedProfile, variant: "full" }));
    ...
    it('should hide avatar when showAvatar is false', () => {
        renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "full", showAvatar: false }));
        expect(screen.queryByRole('img')).not.toBeInTheDocument();
        expect(screen.queryByText('TE')).not.toBeInTheDocument();
    });
    it('should hide stats when showStats is false', () => {
        renderWithTheme(_jsx(ProfileCard, { profile: mockProfile, variant: "full", showStats: false }));
        expect(screen.queryByText('Tasks')).not.toBeInTheDocument();
...
describe('AchievementBadge', () => {
    ...
    it('should render medium size correctly', () => {
        renderWithTheme(_jsx(AchievementBadge, { achievement: mockAchievement, size: "md" }));
        const badge = screen.getByRole('img');
        expect(badge).toHaveStyle({ width: '48px', height: '48px' });
    });
    it('should render large size correctly', () => {
        renderWithTheme(_jsx(AchievementBadge, { achievement: mockAchievement, size: "lg" }));
        const badge = screen.getByRole('img');
        expect(badge).toHaveStyle({ width: '72px', height: '72px' });
    });
    it('should show tooltip on hover when showTooltip is true', () => {
        renderWithTheme(_jsx(AchievementBadge, { achievement: mockAchievement, size: "md", showTooltip: true }));
        const badge = screen.getByRole('img');
    ...
    it('should not show tooltip when showTooltip is false', () => {
        renderWithTheme(_jsx(AchievementBadge, { achievement: mockAchievement, size: "md", showTooltip: false }));
        const badge = screen.getByRole('img');
        fireEvent.mouseEnter(badge);
    ...
    it('should show progress ring for locked achievements with progress', () => {
        ...
        renderWithTheme(_jsx(AchievementBadge, { achievement: lockedAchievement, size: "md" }));
...
describe('LevelProgress', () => {
    it('should render correct level number', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 15, xp: 2500, showDetails: true }));
        expect(screen.getByText('15')).toBeInTheDocument();
        expect(screen.getByText('Current Level')).toBeInTheDocument();
    });
    it('should calculate and display correct XP progress', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 5, xp: 1600, showDetails: true }));
    ...
    it('should calculate XP progress correctly for mid-level', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 5, xp: 2050, showDetails: true }));
    ...
    it('should hide details when showDetails is false', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 5, xp: 2050, showDetails: false }));
    ...
    it('should show correct tier name for gold level (20-29)', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 25, xp: 6400, showDetails: true }));
        expect(screen.getByText('Gold')).toBeInTheDocument();
    });
    it('should show correct tier name for platinum level (30-49)', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 35, xp: 12500, showDetails: true }));
        expect(screen.getByText('Platinum')).toBeInTheDocument();
    });
    it('should show correct tier name for diamond level (50+)', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 50, xp: 25000, showDetails: true }));
        expect(screen.getByText('Diamond')).toBeInTheDocument();
    });
    it('should handle level 1 correctly', () => {
        renderWithTheme(_jsx(LevelProgress, { level: 1, xp: 0, showDetails: true }));
...
describe('ReputationScore', () => {
    it('should render score value in the center', () => {
        renderWithTheme(_jsx(ReputationScore, { score: 85, size: "md", showTrend: true }));
        expect(screen.getByText('85')).toBeInTheDocument();
    });
    it('should render small size correctly', () => {
        const { container } = renderWithTheme(_jsx(ReputationScore, { score: 85, size: "sm", showTrend: true }));
        const svg = container.querySelector('svg');
        expect(svg).toHaveAttribute('width', '48');
        expect(svg).toHaveAttribute('height', '48');
    });
    it('should render medium size correctly', () => {
        const { container } = renderWithTheme(_jsx(ReputationScore, { score: 85, size: "md", showTrend: true }));
        const svg = container.querySelector('svg');
        expect(svg).toHaveAttribute('width', '72');
        expect(svg).toHaveAttribute('height', '72');
    });
    it('should render large size correctly', () => {
        const { container } = renderWithTheme(_jsx(ReputationScore, { score: 85, size: "lg", showTrend: true }));
        const svg = container.querySelector('svg');
        expect(svg).toHaveAttribute('width', '120');
        expect(svg).toHaveAttribute('height', '120');
    });
    it('should show up trend indicator', () => {
        renderWithTheme(_jsx(ReputationScore, { score: 85, size: "md", showTrend: true, trend: "up" }));
        expect(screen.getByText('↑')).toBeInTheDocument();
        expect(screen.getByText('Reputation')).toBeInTheDocument();
    });
    it('should show down trend indicator', () => {
        renderWithTheme(_jsx(ReputationScore, { score: 85, size: "md", showTrend: true, trend: "down" }));
        expect(screen.getByText('↓')).toBeInTheDocument();
    });
    it('should show stable trend indicator', () => {
        renderWithTheme(_jsx(ReputationScore, { score: 85, size: "md", showTrend: true, trend: "stable" }));
        expect(screen.getByText('→')).toBeInTheDocument();
    });
    it('should hide trend when showTrend is false', () => {
        renderWithTheme(_jsx(ReputationScore, { score: 85, size: "md", showTrend: false }));
    ...
    it('should apply green color for high scores (90+)', () => {
        const { container } = renderWithTheme(_jsx(ReputationScore, { score: 95, size: "md", showTrend: true }));
    ...
    it('should apply primary color for good scores (70-89)', () => {
        const { container } = renderWithTheme(_jsx(ReputationScore, { score: 80, size: "md", showTrend: true }));
        const progressCircle = container.querySelectorAll('circle')[1];
    ...
    it('should apply warning color for moderate scores (50-69)', () => {
        const { container } = renderWithTheme(_jsx(ReputationScore, { score: 60, size: "md", showTrend: true }));
        const progressCircle = container.querySelectorAll('circle')[1];
        expect(progressCircle).toHaveAttribute('stroke', lightTheme.colors.warning);
    });
    it('should apply error color for low scores (<50)', () => {
        const { container } = renderWithTheme(_jsx(ReputationScore, { score: 40, size: "md", showTrend: true }));
        const progressCircle = container.querySelectorAll('circle')[1];
...
describe('ProfileStatsGrid', () => {
    ...
    it('should handle zero values correctly', () => {
        ...
        renderWithTheme(_jsx(ProfileStatsGrid, { stats: zeroStats, columns: 3 }));
...
describe('SkillTags', () => {
    ...
    it('should render all skills when no maxDisplay limit', () => {
        renderWithTheme(_jsx(SkillTags, { skills: mockSkills, onTagClick: mockOnTagClick }));
        mockSkills.forEach(skill => {
            expect(screen.getByText(skill)).toBeInTheDocument();
        });
    });
    it('should limit displayed skills when maxDisplay is set', () => {
        renderWithTheme(_jsx(SkillTags, { skills: mockSkills, maxDisplay: 3, onTagClick: mockOnTagClick }));
    ...
    it('should not show "more" button when skills count equals maxDisplay', () => {
        renderWithTheme(_jsx(SkillTags, { skills: mockSkills.slice(0, 3), maxDisplay: 3, onTagClick: mockOnTagClick }));
        expect(screen.queryByText(/more/)).not.toBeInTheDocument();
    });
    it('should not show "more" button when skills count is less than maxDisplay', () => {
        renderWithTheme(_jsx(SkillTags, { skills: mockSkills.slice(0, 2), maxDisplay: 3, onTagClick: mockOnTagClick }));
        expect(screen.queryByText(/more/)).not.toBeInTheDocument();
    });
    ...
    it('should not make tags clickable when onTagClick is not provided', () => {
        renderWithTheme(_jsx(SkillTags, { skills: mockSkills }));
        const typeScriptTag = screen.getByText('TypeScript');
        expect(typeScriptTag).toBeInTheDocument();
        // Tags should still render but without click handler
    });
    it('should handle empty skills array', () => {
        renderWithTheme(_jsx(SkillTags, { skills: [], onTagClick: mockOnTagClick }));
    ...
    it('should handle skills with duplicate names (using index as key)', () => {
        ...
        renderWithTheme(_jsx(SkillTags, { skills: duplicateSkills, onTagClick: mockOnTagClick }));
...
//# sourceMappingURL=profile-components.test.js.map